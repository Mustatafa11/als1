    ...
    if(message.author.bot) return;
            if (!points[message.author.id]) points[message.author.id] = {
             points: 0,id: message.author.id
              ...
              if (message.content.startsWith(prefix + 'فكك') || message.content.startsWith(prefix+"fkk") || message.content.startsWith("فكك")) {
...
client.on('message', message => {
  ...
  if (!points[message.author.id]) points[message.author.id] = {
             points: 0,id: message.author.id
           };if (message.content.startsWith(prefix + 'لغز') || message.content.startsWith("لغز") || message.content.startsWith(prefix+"puzzle")) {
	if(!message.channel.guild) return message.reply('**هذا الأمر للسيرفرات فقط**').then(m => m.delete(3000));
...
client.on('message', message => {
    ...
    if (message.content.startsWith(prefix+ 'ركب') || message.content.startsWith("ركب") || message.content.startsWith(prefix+"rkb")) {
      if(!message.channel.guild) return message.reply('**هذا الأمر للسيرفرات فقط**').then(m => m.delete(3000));
...
client.on('message', message => {
	 if(message.author.bot) return;
      ...
      if (message.content.startsWith(prefix + 'اسرع') || message.content.startsWith("اسرع") ||  message.content.startsWith(prefix+"fast")) {
        if(!message.channel.guild) return message.reply('**هذا الأمر للسيرفرات فقط**').then(m => m.delete(3000));
...
message.channel.sendFile(canvas.toBuffer());
 ...
 client.on('message', message => {
    ...
    if (message.content.startsWith(prefix + 'رياضيات') || message.content.startsWith("رياضيات")  || message.content.startsWith(prefix+"math")) {
      if(!message.channel.guild) return message.reply('**هذا الأمر للسيرفرات فقط**').then(m => m.delete(3000));
...
client.on('message', message => {
      if(message.author.bot) return;
if (message.content.startsWith(prefix + 'top') || message.content.startsWith(prefix + 'توب') || message.content.startsWith("توب")) {
    let _top = 1;
...
client.on('message', message => {
      if(message.author.bot) return;
if (message.content.startsWith(prefix + 'نقاطي') || message.content.startsWith("نقاطي") || message.content.startsWith(prefix+"point") || message.content.startsWith(prefix+"points")) {
	if(!message.channel.guild) return message.reply('**هذا الأمر للسيرفرات فقط**').then(m => m.delete(3000));
...
client.on('message' , message => {
 ...
 let array_of_mentions = message.mentions.users.array();
  ...
  if (array_of_mentions.length == 1 || array_of_mentions.length == 2) {
    ...
    .catch(console.error);
    message.channel.send('جاري تحميل... يجرى انتظار ظهور 🆗 رياكشن.')
    ...
    message.channel.send(`منشن لاعب اخر $xo @uesr`)
